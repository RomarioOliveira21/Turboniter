<div>
	<div class="row">
		<div class="col-12">
			<h5 class="ms-2 mt-2"><i class="fa-solid fa-calculator cl-orange"></i> Relatório Faturamento</h5>
			<hr>
		</div>
	</div>
	...
	<div class="shadow rounded p-2 mt-3" id="content-tabs" style="display: none;">
		<div class="row">
			<div class="col m-1 z-3 d-flex justify-content-end align-items-center">
				<div id="content-prev-next" class="p-2 rounded d-flex flex-nowrap bg-card-light">
					...
					<div class="text-center overflow-x-hidden" style="min-width: 107px;">
						<p class="text-nowrap surge-da-esquerda m-0 fw-bold" id="input-filtro-dia"></p>
					</div>
					<button title="Próxino dia" id="next" class="btn-sm btn-orange"><i class="fas fa-long-arrow-alt-right"></i></button>
				</div>
			</div>
		</div>
		<div class="p-2 mt-3" id="content-cards-tipo-condicao" style="display: none;">
				...
				<div class="tab-pane fade show active p-2" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="1">
					...
					<div class="tab-content" id="myTabContent">
						<div class="tab-pane fade show active" id="r-tipo-con-tab-pane" role="tabpanel" aria-labelledby="r-tipo-con-tab" tabindex="0">
							<div class="row flex-wrap p-2 justify-content-center" id="cards-tipo-condicao"></div>
						</div>

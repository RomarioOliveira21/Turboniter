...
<body>
	...
	<div class="container-fluid">
		<div class="p-2 mb-4 bg-body-tertiary rounded-3">
			<h5 id="titulo" class="fw-bold text-secondary">Relatório Contas a Receber</h5>
		</div>
	...
	<div class="bg-white p-1 mt-auto">
		<div class="copyright text-center">
			<span>copyright &copy;
				...
				<b>
					<a href="https://veredastecnologia.com.br" target="_blank">
		...
		<div class="modal-dialog modal-xl bg-light modal-dialog-scrollable rounded">
			<div class="modal-content border-0">
				<div class="modal-header">
					<div>
						<h1 class="modal-title fs-5" id="modal-relatorio-duplicatasLabel"><i class="fas fa-long-arrow-alt-down cl-orange"></i> Duplicatas</h1>
	...
	<script src="<?= site_url("public/assets/js/relatorio-compartilhado/contas-a-receber.js") ?>"></script>
